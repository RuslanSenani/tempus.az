                    ...
                    <div class="item active">
                        ...
                        <div class="col-md-6 col-sm-6 no-padding">
                            <div class="banner-right">
                                <img src="{{asset("assets")}}/images/banner-main.png" alt="banner-main"/>
                            </div>
                        </div>
                    </div>
                    <div class="item">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 opening-hours">
                    ...
                    <div class="col-md-6 message-block">
                        ...
                        <p>Dignissimos ducimus qui blanditii sentium volta tum deleniti atque cori las quos dolores et
                            quas mole.</p>
                        <a href="#">More Details<i class="fa fa-caret-right"></i></a>
                    </div>
                </div><!-- Opening Hours /- -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="service-block">
                                <div class="service-block-icon">
                                    ...
                                    <i><img src="{{asset("assets")}}/images/appoinment-latter-white.png" alt="appoinment-latter-white"/></i>
                                </div>
                                <div class="service-block-content">
        ...
        <div class="we-are-best col-md-6 col-sm-12 no-padding">
            ...
            <div class="we-are-best-block">
                ...
                <div class="we-are-best-content">
                    ...
                    <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores euas molestias excepturi
        ...
        <div class="col-md-6 col-sm-12 departments no-padding">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                    ...
                    <div id="dept-type-1" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <p>Blanditiis praesentium voluptatum delniti atque corrupti quos dlores quas molestias
                                excepturi sint occaecati cupiditate non provident siili sunt in culpa qui officia
                                deserunt.</p>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="dept-type-5" class="panel-collapse collapse" role="tabpanel"
                         aria-labelledby="dept-heading5">
                        <div class="panel-img">
                            <img src="{{asset("assets")}}/images/panel-img-1.jpg" alt="panel-img"/>
                        </div>
                        <div class="panel-body">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="dept-type-6" class="panel-collapse collapse" role="tabpanel"
                         aria-labelledby="dept-heading6">
                        <div class="panel-img">
                            <img src="{{asset("assets")}}/images/panel-img-1.jpg" alt="panel-img"/>
                        </div>
                        <div class="panel-body">
                ...
                <div class="counter-app">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="statistics-box">
                            <i class="statistics-icon"><img alt="statistics-icon" src="{{asset("assets")}}/images/icon-1.png"></i>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="statistics-box">
                            <i class="statistics-icon"><img alt="statistics-icon" src="{{asset("assets")}}/images/icon-2.png"></i>
                            <div class="statistics-content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="statistics-box">
                            <i class="statistics-icon"><img alt="statistics-icon" src="{{asset("assets")}}/images/icon-3.png"></i>
                            <div class="statistics-content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="statistics-box">
                            <i class="statistics-icon"><img alt="statistics-icon" src="{{asset("assets")}}/images/icon-4.png"></i>
                            <div class="statistics-content">
        ...
        <div class="container">
            ...
            <div class="row">
                <article class="col-md-6 col-sm-12 col-xs-12">
                    <div class="entry-header">
                        <div class="entry-cover">
                            <a href="blog-post.html"><img src="{{asset("assets")}}/images/latest-news-1.jpg" alt="latest-news"/></a>
                ...
                <article class="col-md-6 col-sm-12 col-xs-12">
                    <div class="entry-header">
                        <div class="entry-cover">
                            <a href="blog-post.html"><img src="{{asset("assets")}}/images/latest-news-2.jpg" alt="latest-news"/></a>
                            <a href="blog-post.html" class="read-more"><i class="fa fa-link"></i>Read More</a>
                        </div>
                    </div>
                    <div class="entry-content">
