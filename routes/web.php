...
// 1. Əgər dil prefiksi yoxdursa, avtomatik olaraq default dilə yönləndir (məs: /az)
Route::get('/', function () {
    return redirect('/' . app()->getLocale());
});


// 2. Bütün marşrutları dil prefiksi ilə qruplaşdırırıq
Route::group([
    'prefix' => '{locale}',
    ...
    // Sənin istədiyin butifar-50 formatı üçün (Bazada dəyişiklik etmədən)
    Route::get('/preparation/{slug_and_id}', [FrontHomeController::class, 'preparationDetail'])->name('preparation-detail');
